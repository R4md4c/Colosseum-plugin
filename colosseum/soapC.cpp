...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.16 2011-04-25 10:31:07 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_PointerTo_ns1__LinesCountResponse:
		return soap_in_PointerTo_ns1__LinesCountResponse(soap, NULL, NULL, "ns1:LinesCountResponse");
	case SOAP_TYPE_PointerTo_ns1__LinesCount:
		return soap_in_PointerTo_ns1__LinesCount(soap, NULL, NULL, "ns1:LinesCount");
	...
	{	const char *t = soap->type;
		...
		t = soap->tag;
		if (!soap_match_tag(soap, t, "ns1:LinesCountResponse"))
		{	*type = SOAP_TYPE__ns1__LinesCountResponse;
			return soap_in__ns1__LinesCountResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns1:LinesCount"))
		{	*type = SOAP_TYPE__ns1__LinesCount;
			return soap_in__ns1__LinesCount(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE__ns1__LinesCountResponse:
		return ((_ns1__LinesCountResponse *)ptr)->soap_out(soap, "ns1:LinesCountResponse", id, NULL);
	case SOAP_TYPE__ns1__LinesCount:
		return ((_ns1__LinesCount *)ptr)->soap_out(soap, "ns1:LinesCount", id, NULL);
	...
	case SOAP_TYPE_PointerTo_ns1__LinesCountResponse:
		return soap_out_PointerTo_ns1__LinesCountResponse(soap, tag, id, (_ns1__LinesCountResponse *const*)ptr, "ns1:LinesCountResponse");
	case SOAP_TYPE_PointerTo_ns1__LinesCount:
		return soap_out_PointerTo_ns1__LinesCount(soap, tag, id, (_ns1__LinesCount *const*)ptr, "ns1:LinesCount");
	case SOAP_TYPE_PointerTo_ns1__getObjectResponse:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_ns3__char__:
		...
		break;
	case SOAP_TYPE__ns1__LinesCountResponse:
		((_ns1__LinesCountResponse *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__LinesCount:
		((_ns1__LinesCount *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__getObjectResponse:
	...
	case SOAP_TYPE_xsd__anyType:
		...
		break;
	case SOAP_TYPE___ns1__LinesCount:
		soap_serialize___ns1__LinesCount(soap, (const struct __ns1__LinesCount *)ptr);
		break;
	...
	case SOAP_TYPE___ns1__OpenSession:
		...
		break;
	case SOAP_TYPE_PointerTo_ns1__LinesCountResponse:
		soap_serialize_PointerTo_ns1__LinesCountResponse(soap, (_ns1__LinesCountResponse *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__LinesCount:
		soap_serialize_PointerTo_ns1__LinesCount(soap, (_ns1__LinesCount *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__getObjectResponse:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE__ns1__LinesCount:
		return (void*)soap_instantiate__ns1__LinesCount(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__LinesCountResponse:
		return (void*)soap_instantiate__ns1__LinesCountResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__OpenSession:
	...
	case SOAP_TYPE___ns1__LinesCount:
		return (void*)soap_instantiate___ns1__LinesCount(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__LinesCount:
		if (p->size < 0)
			SOAP_DELETE((_ns1__LinesCount*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__LinesCount*)p->ptr);
		break;
	case SOAP_TYPE__ns1__LinesCountResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__LinesCountResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__LinesCountResponse*)p->ptr);
		break;
	case SOAP_TYPE___ns1__OpenSession:
		if (p->size < 0)
	...
	case SOAP_TYPE___ns1__LinesCount:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__LinesCount*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__LinesCount*)p->ptr);
		break;
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
void _ns1__LinesCountResponse::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__LinesCountResponse::LinesCountResult = NULL;
	/* transient soap skipped */
}

void _ns1__LinesCountResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_PointerToint(soap, &this->_ns1__LinesCountResponse::LinesCountResult);
	/* transient soap skipped */
}

int _ns1__LinesCountResponse::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__LinesCountResponse(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__LinesCountResponse(struct soap *soap, const char *tag, int id, const _ns1__LinesCountResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__LinesCountResponse), type))
		return soap->error;
	if (a->LinesCountResult)
		soap_element_result(soap, "ns1:LinesCountResult");
	if (soap_out_PointerToint(soap, "ns1:LinesCountResult", -1, &(a->_ns1__LinesCountResponse::LinesCountResult), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}

void *_ns1__LinesCountResponse::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__LinesCountResponse(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__LinesCountResponse * SOAP_FMAC4 soap_in__ns1__LinesCountResponse(struct soap *soap, const char *tag, _ns1__LinesCountResponse *a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__LinesCountResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__LinesCountResponse, sizeof(_ns1__LinesCountResponse), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__LinesCountResponse)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__LinesCountResponse *)a->soap_in(soap, tag, type);
		}
	}
	size_t soap_flag_LinesCountResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_LinesCountResult1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToint(soap, "ns1:LinesCountResult", &(a->_ns1__LinesCountResponse::LinesCountResult), "xsd:int"))
				{	soap_flag_LinesCountResult1--;
					continue;
				}
			/* transient soap skipped */
			soap_check_result(soap, "ns1:LinesCountResult");
	...
	{	a = (_ns1__LinesCountResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__LinesCountResponse, 0, sizeof(_ns1__LinesCountResponse), 0, soap_copy__ns1__LinesCountResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
int _ns1__LinesCountResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE__ns1__LinesCountResponse);
	if (this->soap_out(soap, tag?tag:"ns1:LinesCountResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__LinesCountResponse::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__LinesCountResponse(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__LinesCountResponse * SOAP_FMAC4 soap_get__ns1__LinesCountResponse(struct soap *soap, _ns1__LinesCountResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__LinesCountResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__LinesCountResponse * SOAP_FMAC2 soap_instantiate__ns1__LinesCountResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__LinesCountResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__LinesCountResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__LinesCountResponse);
		if (size)
			*size = sizeof(_ns1__LinesCountResponse);
		((_ns1__LinesCountResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__LinesCountResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(_ns1__LinesCountResponse);
		for (int i = 0; i < n; i++)
			((_ns1__LinesCountResponse*)cp->ptr)[i].soap = soap;
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (_ns1__LinesCountResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__LinesCountResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__LinesCountResponse %p -> %p\n", q, p));
	*(_ns1__LinesCountResponse*)p = *(_ns1__LinesCountResponse*)q;
}

void _ns1__LinesCount::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__LinesCount::uuid = NULL;
	/* transient soap skipped */
}

void _ns1__LinesCount::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_PointerTostd__string(soap, &this->_ns1__LinesCount::uuid);
	/* transient soap skipped */
}

int _ns1__LinesCount::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__LinesCount(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__LinesCount(struct soap *soap, const char *tag, int id, const _ns1__LinesCount *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__LinesCount), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns1:uuid", -1, &(a->_ns1__LinesCount::uuid), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}

void *_ns1__LinesCount::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__LinesCount(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__LinesCount * SOAP_FMAC4 soap_in__ns1__LinesCount(struct soap *soap, const char *tag, _ns1__LinesCount *a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__LinesCount *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__LinesCount, sizeof(_ns1__LinesCount), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__LinesCount)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__LinesCount *)a->soap_in(soap, tag, type);
		}
	}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_uuid1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "ns1:uuid", &(a->_ns1__LinesCount::uuid), "xsd:string"))
				{	soap_flag_uuid1--;
					continue;
				}
			/* transient soap skipped */
	...
	{	a = (_ns1__LinesCount *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__LinesCount, 0, sizeof(_ns1__LinesCount), 0, soap_copy__ns1__LinesCount);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
int _ns1__LinesCount::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE__ns1__LinesCount);
	if (this->soap_out(soap, tag?tag:"ns1:LinesCount", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__LinesCount::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__LinesCount(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__LinesCount * SOAP_FMAC4 soap_get__ns1__LinesCount(struct soap *soap, _ns1__LinesCount *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__LinesCount(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__LinesCount * SOAP_FMAC2 soap_instantiate__ns1__LinesCount(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__LinesCount(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__LinesCount, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__LinesCount);
		if (size)
			*size = sizeof(_ns1__LinesCount);
		((_ns1__LinesCount*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__LinesCount[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(_ns1__LinesCount);
		for (int i = 0; i < n; i++)
			((_ns1__LinesCount*)cp->ptr)[i].soap = soap;
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (_ns1__LinesCount*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__LinesCount(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__LinesCount %p -> %p\n", q, p));
	*(_ns1__LinesCount*)p = *(_ns1__LinesCount*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__LinesCount(struct soap *soap, struct __ns1__LinesCount *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__LinesCount = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__LinesCount(struct soap *soap, const struct __ns1__LinesCount *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTo_ns1__LinesCount(soap, &a->ns1__LinesCount);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__LinesCount(struct soap *soap, const char *tag, int id, const struct __ns1__LinesCount *a, const char *type)
{
	if (soap_out_PointerTo_ns1__LinesCount(soap, "ns1:LinesCount", -1, &a->ns1__LinesCount, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__LinesCount * SOAP_FMAC4 soap_in___ns1__LinesCount(struct soap *soap, const char *tag, struct __ns1__LinesCount *a, const char *type)
{
	size_t soap_flag_ns1__LinesCount = 1;
	short soap_flag;
	a = (struct __ns1__LinesCount *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__LinesCount, sizeof(struct __ns1__LinesCount), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__LinesCount(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__LinesCount && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__LinesCount(soap, "ns1:LinesCount", &a->ns1__LinesCount, ""))
				{	soap_flag_ns1__LinesCount--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__LinesCount(struct soap *soap, const struct __ns1__LinesCount *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__LinesCount(soap, tag?tag:"-ns1:LinesCount", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__LinesCount * SOAP_FMAC4 soap_get___ns1__LinesCount(struct soap *soap, struct __ns1__LinesCount *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__LinesCount(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__LinesCount * SOAP_FMAC2 soap_instantiate___ns1__LinesCount(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__LinesCount(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__LinesCount, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__LinesCount);
		if (size)
			*size = sizeof(struct __ns1__LinesCount);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__LinesCount[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct __ns1__LinesCount);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct __ns1__LinesCount*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__LinesCount(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__LinesCount %p -> %p\n", q, p));
	*(struct __ns1__LinesCount*)p = *(struct __ns1__LinesCount*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__LinesCountResponse(struct soap *soap, _ns1__LinesCountResponse *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__LinesCountResponse))
		(*a)->soap_serialize(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__LinesCountResponse(struct soap *soap, const char *tag, int id, _ns1__LinesCountResponse *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__LinesCountResponse);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, type);
}

SOAP_FMAC3 _ns1__LinesCountResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__LinesCountResponse(struct soap *soap, const char *tag, _ns1__LinesCountResponse **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__LinesCountResponse **)soap_malloc(soap, sizeof(_ns1__LinesCountResponse *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__LinesCountResponse *)soap_instantiate__ns1__LinesCountResponse(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
	...
	{	_ns1__LinesCountResponse ** p = (_ns1__LinesCountResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__LinesCountResponse, sizeof(_ns1__LinesCountResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__LinesCountResponse(struct soap *soap, _ns1__LinesCountResponse *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerTo_ns1__LinesCountResponse);
	if (soap_out_PointerTo_ns1__LinesCountResponse(soap, tag?tag:"ns1:LinesCountResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__LinesCountResponse ** SOAP_FMAC4 soap_get_PointerTo_ns1__LinesCountResponse(struct soap *soap, _ns1__LinesCountResponse **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__LinesCountResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__LinesCount(struct soap *soap, _ns1__LinesCount *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__LinesCount))
		(*a)->soap_serialize(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__LinesCount(struct soap *soap, const char *tag, int id, _ns1__LinesCount *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__LinesCount);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, type);
}

SOAP_FMAC3 _ns1__LinesCount ** SOAP_FMAC4 soap_in_PointerTo_ns1__LinesCount(struct soap *soap, const char *tag, _ns1__LinesCount **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__LinesCount **)soap_malloc(soap, sizeof(_ns1__LinesCount *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__LinesCount *)soap_instantiate__ns1__LinesCount(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
		if (!(*a)->soap_in(soap, tag, NULL))
			return NULL;
	...
	{	_ns1__LinesCount ** p = (_ns1__LinesCount **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__LinesCount, sizeof(_ns1__LinesCount), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__LinesCount(struct soap *soap, _ns1__LinesCount *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerTo_ns1__LinesCount);
	if (soap_out_PointerTo_ns1__LinesCount(soap, tag?tag:"ns1:LinesCount", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__LinesCount ** SOAP_FMAC4 soap_get_PointerTo_ns1__LinesCount(struct soap *soap, _ns1__LinesCount **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__LinesCount(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
